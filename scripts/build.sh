...
ISUINT8ARRAY_REGEX="s/return\x20Uint8Array\.prototype\.isPrototypeOf\(input\);/return\x20Uint8Array\.prototype\.isPrototypeOf\(input\)\x20\|\|\x20globalThis\.Uint8Array\.prototype\.isPrototypeOf\(input\);/g"
