...
copy_dependencies() {
  ...
  cp node_modules/pdfjs-dist/build/pdf.min.mjs $OUTPUT_DIRECTORY/lib/pdf.min.mjs
  cp node_modules/pdfjs-dist/build/pdf.worker.min.mjs $OUTPUT_DIRECTORY/lib/pdf.worker.min.mjs
