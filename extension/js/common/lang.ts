...
export const Lang = {
  ...
  pgpBlock: {
    ...
    passphraseAttemptIntroduce: (attemptsLeft: string) =>
      `For your protection and data security, there are currently only ${attemptsLeft} <br />If attempts are exceeded, there will a 5-minute cooldown period before you may try again.`,
