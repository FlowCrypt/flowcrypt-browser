...
import { PgpUtil, PgpMsgMethod } from '../../../../js/common/core/crypto/pgp/pgp-msg.js';
...
export class EncryptedMsgMailFormatter extends BaseMailFormatter {
  ...
  private encryptDataArmor = async (data: Buf, pwd: string | undefined, pubs: PubkeyResult[], signingPrv?: Key): Promise<PgpMsgMethod.EncryptAnyArmorResult> => {
    ...
    return await PgpUtil.encryptMessage({ pubkeys: pubsForEncryption, signingPrv, pwd, data, armor: true, date: encryptAsOfDate }) as PgpMsgMethod.EncryptAnyArmorResult;
  }
