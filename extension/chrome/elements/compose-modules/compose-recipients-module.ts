  ...
  */
    ...
    this.view.S.cached('contacts')
      ...
      .click(this.view.setHandler(async () => {
        ...
        if (authResult.result === 'Success') {
          ...
          await Ui.modal.error(`Could not enable Google Contact search. ${Lang.general.writeMeToFixIt(this.view.isFesUsed())}\n\n[${authResult.result}] ${authResult.error}`);
        }
      }));
  };
  ...
  private authContacts = async (acctEmail: string) => {
    ...
    if (authRes.result === 'Success') {
      ...
      await Ui.modal.error(Lang.general.somethingWentWrongTryAgain(this.view.isFesUsed()));
    }
  };
