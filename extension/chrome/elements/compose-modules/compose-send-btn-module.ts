...
export class ComposeSendBtnModule extends ViewModule<ComposeView> {
  ...
  public setHandlers = (): void => {
    const ctrlEnter = Ui.ctrlEnter(() => !this.view.sizeModule.composeWindowIsMinimized && this.extractProcessSendMsg());
    this.view.S.cached('subject').add(this.view.S.cached('compose')).keypress(ctrlEnter);
