...
export let defineElementTests = (testVariant: TestVariant, testWithNewBrowser: TestWithNewBrowser) => {

  if (testVariant !== 'CONSUMER-LIVE-GMAIL') {

    ava.default('compose[global:compatibility] - elements/pgp_pubkey renders', testWithNewBrowser('compatibility', async (t, browser) => {
