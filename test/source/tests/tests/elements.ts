...
export let define_elements_tests = (test_with_new_browser: TestWithBrowser, test_with_semaphored_global_browser: TestWithBrowser) => {

  ava.test('compose[global] - elements/pgp_pubkey renders', test_with_semaphored_global_browser(async (browser, t) => {
