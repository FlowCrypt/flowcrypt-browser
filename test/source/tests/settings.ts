...
export let defineSettingsTests = (testVariant: TestVariant, testWithBrowser: TestWithBrowser) => {
  ...
  if (testVariant !== 'CONSUMER-LIVE-GMAIL') {
    ...
    ava.default('settings - manual backup several keys', testWithBrowser(undefined, async (t, browser) => {
      ...
      expect(await backupPage.isDisabled('@47FB03183E03A8ED44E3BBFCCEA2D53BB9D24871')).to.equal(true);
      expect(await backupPage.isDisabled('@5A08466253C956E9C76C2E95A35068FD4E037879')).to.equal(true);
