  ...
  if (testVariant !== 'CONSUMER-LIVE-GMAIL') {
    ...
    test(
      ...
      testWithBrowser(async (t, browser) => {
        ...
        expect((oldContact.sortedPubkeys as PubkeyInfoWithLastCheck[])[0].pubkey.lastModified).to.equal(1759869019000);
        await SettingsPageRecipe.toggleScreen(settingsPage, 'additional');
        ...
        expect((expectedOldContact.sortedPubkeys as PubkeyInfoWithLastCheck[])[0].pubkey.lastModified).to.equal(1759869019000);
