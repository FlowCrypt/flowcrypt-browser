  ...
  if (testVariant !== 'CONSUMER-LIVE-GMAIL') {
    ...
    test(
      ...
      testWithBrowser(async (t, browser) => {
        ...
        await SettingsPageRecipe.checkContactKey(contactsFrame, 'ACTIVE', 'OPENPGP', 'AB8C F86E 3715 7C3F 290D 7200 7ED4 3D79 E961 7655');
        ...
        await SettingsPageRecipe.checkContactKey(contactsFrame, 'ACTIVE', 'OPENPGP', '8B8A 05A2 216E E6E4 C5EE 3D54 0D56 88EB F310 2BE7');
    ...
    test(
      ...
      testWithBrowser(async (t, browser) => {
        ...
        await contactsFrame.waitAndClick('@action-back-to-contact-list', { confirmGone: true });
        await contactsFrame.waitAndClick(`@action-show-email-${recipientEmail.replace(/[^a-z0-9]+/g, '')}`);
        await SettingsPageRecipe.checkContactKey(contactsFrame, 'ACTIVE', 'OPENPGP', '6D3E 0986 7544 EE62 7F2E 928F BEE3 A42D 9A9C 8AC9');
    ...
    test(
      ...
      testWithBrowser(async (t, browser) => {
        ...
        await contactsFrame.waitAndClick('@action-back-to-contact-list', { confirmGone: true });
        await contactsFrame.waitAndClick(`@action-show-email-${recipientEmail.replace(/[^a-z0-9]+/g, '')}`);
        await SettingsPageRecipe.checkContactKey(contactsFrame, 'EXPIRED', 'X509', '16BB 4074 03A3 ADC5 5E1E 0E4A F93E EC8F B187 C923');
...
const importExpiredKeyForAutoRefresh = async (settingsPage: ControllablePage) => {
  ...
  await SettingsPageRecipe.checkContactKey(contactsFrame, 'EXPIRED', 'OPENPGP', '6D3E 0986 7544 EE62 7F2E 928F BEE3 A42D 9A9C 8AC9');
  await contactsFrame.waitAndClick(`@action-show-pubkey-6D3E09867544EE627F2E928FBEE3A42D9A9C8AC9-openpgp`, {
    confirmGone: true,
  });
  await contactsFrame.waitForContent('@container-pubkey-details', 'Type: openpgp');
