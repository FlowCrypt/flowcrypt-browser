  ...
  if (testVariant !== 'CONSUMER-LIVE-GMAIL') {
    ...
    ava.default(
      ...
      testWithBrowser(undefined, async (t, browser) => {
        const settingsPage = await BrowserRecipe.openSettingsLoginApprove(
          t,
          browser,
          'setup@prv-create-no-prv-backup.flowcrypt.test'
        );
        await SetupPageRecipe.createKey(
          settingsPage,
          'flowcrypt.test.key.used.pgp',
    ...
    ava.default(
      ...
      testWithBrowser('compatibility', async (t, browser) => {
        ...
        await composePage.waitForContent(
          '@replied-to',
          'to: First Last <flowcrypt.compatibility@gmail.com>, vladimir@flowcrypt.com'
        );
    ...
    ava.default(
      ...
      testWithBrowser(undefined, async (t, browser) => {
        ...
        await dbPage.close();
        const subject =
          'PWD encrypted message with FES web portal - some sends fail with BadRequest error - ' + testVariant;
        let expectedNumberOfPassedMessages = (await GoogleData.withInitializedData(acct)).searchMessagesBySubject(
          subject
        ).length;
        // 1. vague Gmail error with partial success
        let composePage = await ComposePageRecipe.openStandalone(
          t,
          browser,
        ...
        await ComposePageRecipe.fillMsg(
          composePage,
          { to: 'to@example.com', cc: 'cc@example.com', bcc: 'flowcrypt.compatibility@gmail.com' },
          subject
        );
        await composePage.waitAndType('@input-password', 'gO0d-pwd');
        await composePage.waitAndClick('@action-send', { delay: 1 });
        ...
        await ComposePageRecipe.fillMsg(
          composePage,
          { cc: 'cc@example.com', bcc: 'flowcrypt.compatibility@gmail.com' },
          subject
        );
        await composePage.waitAndType('@input-password', 'gO0d-pwd');
        await composePage.waitAndClick('@action-send', { delay: 1 });
    ...
    ava.default(
      ...
      testWithBrowser(undefined, async (t, browser) => {
        ...
        await ComposePageRecipe.fillMsg(
          ...
          'should not send as pass phrase is not known',
          undefined,
          { encrypt: false }
        );
    ...
    ava.default(
      ...
      testWithBrowser('compatibility', async (t, browser) => {
        ...
        await fileInput!.uploadFile(
          ...
          'test/samples/small.pdf',
          'test/samples/large.jpg'
        );
    ...
    ava.default(
      ...
      testWithBrowser('ci.tests.gmail', async (t, browser) => {
        ...
        if (testVariant === 'CONSUMER-MOCK') {
          ...
          const oauthPopup = await browser.newPageTriggeredBy(t, () =>
            composeFrame.waitAndClick('@action-auth-with-contacts-scope')
          );
        ...
        await ComposePageRecipe.pastePublicKeyManually(
          composeFrame,
          inboxPage,
          'testsearchorder9@flowcrypt.com',
          testConstants.smimeCert
        );
        await composeFrame.waitAndClick('@action-close-new-message');
        await inboxPage.waitTillGone('@container-new-message');
    ...
    ava.default(
      ...
      testWithBrowser('compatibility', async (t, browser) => {
        ...
        await ComposePageRecipe.fillMsg(
          ...
          'send signed and encrypted S/MIME without attachment'
        );
        await ComposePageRecipe.pastePublicKeyManually(
          composeFrame,
          inboxPage,
