...
export const get203FAE7076005381 = async () => {
  ...
  return /\-\-\-\-\-BEGIN PGP PUBLIC KEY BLOCK\-\-\-\-\-.*\-\-\-\-\-END PGP PUBLIC KEY BLOCK\-\-\-\-\-/s
    .exec(msgText)![0]
    .replace(/=\r\n/g, '')
    .replace(/=3D/g, '=');
};
...
export const expiredPubkey = `-----BEGIN PGP PUBLIC KEY BLOCK-----
...
export const newerVersionOfExpiredPubkey = `-----BEGIN PGP PUBLIC KEY BLOCK-----
...
export const sha1signpubkey = `-----BEGIN PGP PUBLIC KEY BLOCK-----
...
export const noSigPubKey = `-----BEGIN PGP PUBLIC KEY BLOCK-----


=k70C
-----END PGP PUBLIC KEY BLOCK-----`;
