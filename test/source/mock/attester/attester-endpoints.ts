...
export const mockAttesterEndpoints: HandlersDefinition = {
  '/attester/pub/?': async ({ body }, req) => {
    ...
    if (isGet(req)) {
      ...
      if (['sams50sams50sept@gmail.com', '2864E326A5BE488A'.toLowerCase()].includes(emailOrLongid)) {
...

=o5pe
-----END PGP PUBLIC KEY BLOCK-----`;
