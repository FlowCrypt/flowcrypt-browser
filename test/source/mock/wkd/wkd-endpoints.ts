...
import { wkdAtwkdmockflowcryptlocalcomPrivate } from '../../tests/tooling/consts.js';
...
export const mockWkdEndpoints: HandlersDefinition = {
  '/.well-known/openpgpkey/hu/st5or5guodbnsiqbzp6i34xw59h1sgmw?l=wkd': async () => {
    // direct for wkd@wkd.mock.flowcryptlocal.com
    const pub = await KeyUtil.asPublicKey(await KeyUtil.parse(wkdAtwkdmockflowcryptlocalcomPrivate));
