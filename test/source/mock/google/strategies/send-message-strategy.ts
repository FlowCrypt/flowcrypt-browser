...
import { PgpMsgUtil } from '../../../core/crypto/pgp/pgp-msg-util';
...
class MessageWithFooterTestStrategy implements ITestMsgStrategy {
  ...
  public test = async (mimeMsg: ParsedMail) => {
    ...
    const decrypted = await PgpMsgUtil.decryptMessage({ kisWithPp: keyInfo!, encryptedData: Buf.fromUtfStr(mimeMsg.text) });
