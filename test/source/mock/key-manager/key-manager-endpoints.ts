...
export const MOCK_KM_LAST_INSERTED_KEY: { [acct: string]: { decryptedKey: string, publicKey: string, longid: string } } = {}; // accessed from test runners
