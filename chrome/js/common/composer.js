...
(function() {
  ...
  let app = {
    ...
    storage_set_draft_meta: (store_if_true, draft_id, thread_id, recipients, subject) => new Promise((resolve, reject) => {resolve()}),
    ...
    email_provider_draft_get: (draft_id) => new Promise((resolve, reject) => {reject()}),
    email_provider_draft_create: (mime_message) => new Promise((resolve, reject) => {reject()}),
    email_provider_draft_update: (draft_id, mime_message) => new Promise((resolve, reject) => {reject()}),
    email_provider_draft_delete: (draft_id) => new Promise((resolve, reject) => {reject()}),
    email_provider_message_send: (message, render_upload_progress) => new Promise((resolve, reject) => {reject()}),
    email_provider_search_contacts: (query, known_contacts) => new Promise((resolve, reject) => {resolve([])}),
