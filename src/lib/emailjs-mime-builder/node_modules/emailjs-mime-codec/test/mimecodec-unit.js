    ...
    describe('mimecodec', function() {
        describe('#mimeEncode', function() {
            it('shoud encode UTF-8', function() {
                ...
                expect(mimecodec.mimeEncode(str)).to.equal(encodedStr);
            });
            ...
            it('shoud encode non UTF-8', function() {
                ...
                expect(mimecodec.mimeEncode(buf, encoding)).to.equal(encodedStr);
            });
        });
        ...
        describe('#mimeDecode', function() {
            it('should decode UTF-8', function() {
                ...
                expect(mimecodec.mimeDecode(encodedStr)).to.equal(str);
            });
            ...
            it('should decode non UTF-8', function() {
                ...
                expect(mimecodec.mimeDecode(encodedStr, encoding)).to.equal(str);
            });
        ...
        describe('#base64Encode', function() {
            it('should base64Encode UTF-8', function() {
                ...
                expect(mimecodec.base64Encode(str)).to.equal(encodedStr);
            });
            ...
            it('should base64Encode non UTF-8', function() {
                ...
                expect(mimecodec.base64Encode(buf, encoding)).to.equal(encodedStr);
            });
        });
        ...
        describe('#base64Decode', function() {
            it('should decode UTF-8', function() {
                ...
                expect(mimecodec.base64Decode(encodedStr)).to.equal(str);
            });
            ...
            it('should decode non UTF-8', function() {
                ...
                expect(mimecodec.base64Decode(encodedStr, encoding)).to.equal(str);
            });
        });
        ...
        describe('#quotedPrintableEncode', function() {
            it('should encode UTF-8 to quoted-printable', function() {
                ...
                expect(mimecodec.quotedPrintableEncode(str)).to.equal(encodedStr);
            });
            ...
            it('should encode short string', function() {
                expect('Tere =C3=95=C3=84=C3=96=C3=9C!').to.equal(mimecodec.quotedPrintableEncode(new Uint8Array([0x54, 0x65, 0x72, 0x65, 0x20, 0xD5, 0xC4, 0xD6, 0xDC, 0x21]), 'Latin_1'));
                expect('Tere =C3=95=C3=84=C3=96=C3=9C=C5=A0=C5=BD!').to.equal(mimecodec.quotedPrintableEncode('Tere ÕÄÖÜŠŽ!'));
                expect('Tere =C5=A0=C5=BD!').to.equal(mimecodec.quotedPrintableEncode(new Uint8Array([0x54, 0x65, 0x72, 0x65, 0x20, 0xD0, 0xDE, 0x21]), 'Win-1257'));
            });
            ...
            it('should not wrap between encoded chars', function() {
                ...
                expect(wrappedEncoded).to.equal(mimecodec.quotedPrintableEncode(wrapped));
            });
            ...
            it('should encode long string', function() {
                ...
                expect(longLineEncoded).to.equal(mimecodec.quotedPrintableEncode(longLine));
            });
            ...
            it('should quote at line edge', function() {
                ...
                expect(strEncoded).to.equal(mimecodec.quotedPrintableEncode(str));
            });
            ...
            it('should encode surrogate pair', function() {
                // pile of poo :)
                expect('=F0=9F=92=A9').to.equal(mimecodec.quotedPrintableEncode('\ud83d\udca9'));
            });
        });
        ...
        describe('#quotedPrintableDecode', function() {
            it('should decode quoted-printable to UTF-8', function() {
                ...
                expect(mimecodec.quotedPrintableDecode(encodedStr)).to.equal(str);
            });
            ...
            it('should decode string', function() {
                ...
                expect(longLine).to.equal(mimecodec.quotedPrintableDecode(longLineEncoded));
            });
            ...
            it('should decode string with soft linebreaks', function() {
                ...
                expect(output).to.equal(mimecodec.quotedPrintableDecode(input));
            });

            it('should decode surrogate pair', function() {
                // pile of poo :)
                expect('\ud83d\udca9').to.equal(mimecodec.quotedPrintableDecode('=F0=9F=92=A9'));
            });
        });

        describe('#mimeWordEncode', function() {
            it('should encode', function() {
                expect('=?UTF-8?Q?See_on_=C3=B5hin_test?=').to.equal(mimecodec.mimeWordEncode('See on õhin test'));
            });

            it('should QP-encode mime word', function() {
                expect('=?UTF-8?Q?J=C3=B5ge-va=C5=BD?=').to.equal(mimecodec.mimeWordEncode(new Uint8Array([0x4A, 0xF5, 0x67, 0x65, 0x2D, 0x76, 0x61, 0xDE]), 'Q', 'iso-8859-13'));
            });
        });
        ...
        describe('#mimeWordsEncode', function() {
            it('should encode Ascii range', function() {
                ...
                expect(mimecodec.mimeWordsEncode(input1, 'Q', 52)).to.equal(output1);
                expect(mimecodec.mimeWordsEncode(input2, 'Q', 52)).to.equal(output2);
            });
        });

        describe('#mimeWordsDecode', function() {
            it('should decode', function() {
                expect('Hello: See on õhin test').to.equal(mimecodec.mimeWordsDecode('Hello: =?UTF-8?q?See_on_=C3=B5hin_test?='));
                expect('See on õhin test').to.equal(mimecodec.mimeWordDecode('=?UTF-8?q?See_on_=C3=B5hin_test?='));
            });

            it('should decode mime words', function() {
                expect('Jõge-vaŽ zz Jõge-vaŽJõge-vaŽJõge-vaŽ').to.equal(mimecodec.mimeWordsDecode('=?ISO-8859-13?Q?J=F5ge-va=DE?= zz =?ISO-8859-13?Q?J=F5ge-va=DE?= =?ISO-8859-13?Q?J=F5ge-va=DE?= =?ISO-8859-13?Q?J=F5ge-va=DE?='));
                expect('Sssś Lałalalala').to.equal(mimecodec.mimeWordsDecode('=?UTF-8?B?U3NzxZsgTGHFgmFsYQ==?= =?UTF-8?B?bGFsYQ==?='));
            });

            it('should decode QP-encoded mime word', function() {
                expect('Jõge-vaŽ').to.equal(mimecodec.mimeWordDecode('=?ISO-8859-13?Q?J=F5ge-va=DE?='));
            });
            ...
            it('should decode ascii range', function() {
                ...
                expect(mimecodec.mimeWordsDecode(output1)).to.equal(input1);
            ...
            it('should split QP on maxLength', function() {
                var inputStr = 'Jõgeva Jõgeva Jõgeva mugeva Jõgeva Jõgeva Jõgeva Jõgeva Jõgeva',
                    ...
                    encoded = mimecodec.mimeWordsEncode(inputStr, 'Q', 16);

                expect(outputStr).to.equal(encoded);
                expect(inputStr).to.equal(mimecodec.mimeWordsDecode(encoded));
            });
            ...
            it('should split base64 on maxLength', function() {
                var inputStr = 'Jõgeva Jõgeva Jõgeva mugeva Jõgeva Jõgeva Jõgeva Jõgeva Jõgeva',
                    ...
                    encoded = mimecodec.mimeWordsEncode(inputStr, 'B', 19);
            ...
            it('should ignore language param', function() {
                expect('Hello: See on õhin test').to.equal(mimecodec.mimeWordsDecode('Hello: =?UTF-8*EN?q?See_on_=C3=B5hin_test?='));
            });
        });
        ...
        describe('#continuationEncode', function() {
            it('should return quoted', function() {
                ...
                }]).to.deep.equal(mimecodec.continuationEncode('title', 'this is just a title', 500));
            });
            ...
            it('should encode and split ascii', function() {
                expect([{
                    ...
                    key: 'title*3',
                    value: 'title'
                }]).to.deep.equal(mimecodec.continuationEncode('title', 'this is just a title', 5));
            });
            ...
            it('should encode and split unicode', function() {
                expect([{
                    ...
                    key: 'title*3*',
                    value: '%C3%BC'
                }]).to.deep.equal(mimecodec.continuationEncode('title', 'this is just a title õäöü', 20));
            });
            ...
            it('should encode and decode', function() {
                ...
                var headerLine = 'content-disposition: attachment; ' + mimecodec.continuationEncode('filename', input, 50).map(function(item) {
        ...
        describe('#foldLines', function() {
            it('should Fold long header line', function() {
                var inputStr = 'Subject: Testin command line kirja õkva kakva mõni tõnis kõllas põllas tõllas rõllas jušla kušla tušla musla',
                    ...
                    encodedHeaderLine = mimecodec.mimeWordsEncode(inputStr, 'Q', 52);

                expect(outputStr).to.equal(mimecodec.foldLines(encodedHeaderLine, 76));
            });
            ...
            it('should Fold flowed text', function() {
                ...
                expect(outputStr).to.equal(mimecodec.foldLines(inputStr, 76, true));
            });
            ...
            it('should fold one long line', function() {
                ...
                expect(outputStr).to.equal(mimecodec.foldLines(inputStr, 76));
            });
        });
        ...
        describe('#headerLineEncode', function() {
            it('should encode and fold header line', function() {
                var key = 'Subject',
                    ...
                    ' =?UTF-8?Q?llas_t=C3=B5llas_r=C3=B5llas_ju=C5=A1la_?=\r\n' +
                    ' =?UTF-8?Q?ku=C5=A1la_tu=C5=A1la?= musla',
                    encodedHeaderLine = mimecodec.headerLineEncode(key, value);
        ...
        describe('#headerLinesDecode', function() {
            it('should decode headers', function() {
                ...
                expect(headersObj).to.deep.equal(mimecodec.headerLinesDecode(headersStr));
            });
        });
        ...
        describe('#toTypedArray', function() {
            it('should create Uint8Array', function() {
                ...
                expect(mimecodec.fromTypedArray(input.buffer)).to.equal(str);
                expect(mimecodec.fromTypedArray(input)).to.equal(str);
            });
        });
        ...
        describe('#fromTypedArray', function() {
            it('should create a string from Uint8Array', function() {
                ...
                expect(mimecodec.fromTypedArray(mimecodec.toTypedArray(str))).to.equal(str);
            });
        });
        ...
        describe('#parseHeaderValue', function() {
            it('should handle default value only', function() {
                ...
                expect(mimecodec.parseHeaderValue(str)).to.deep.equal(obj);
            });
        ...
        describe('#base64', function() {
            describe('#encode', function() {
                it('should convert UTF-8 string to base64', function() {
                    ...
                    expect(b64).to.equal(mimecodec.base64.encode(str));
                });
                ...
                it('should convert Uint8Array to Base64', function() {
                    var buf = new Uint8Array([0x61, 0x62, 0x63, 0x31, 0x32, 0x33, 0xc3, 0x95, 0xc3, 0x84, 0xc3, 0x96, 0xc3, 0x9c, 0xc5, 0xa0, 0xc5, 0xbd, 0xec, 0x8b, 0xa0]),
                        b64 = 'YWJjMTIzw5XDhMOWw5zFoMW97Iug';
                    expect(b64).to.equal(mimecodec.base64.encode(buf));
                });
            });
            ...
            describe('#decode', function() {
                it('should convert base64 to UTF-8 string', function() {
                    ...
                    expect(str).to.equal(mimecodec.base64.decode(b64, 'string'));
                });
                ...
                it('should convert base64 to Uint8Array', function() {
                    ...
                    expect(buf).to.deep.equal(mimecodec.base64.decode(b64, 'arraybuffer'));
                });
                ...
                it('should convert base64 to Uint8Array, default outputEncoding', function() {
                    ...
                    expect(buf).to.deep.equal(mimecodec.base64.decode(b64));
                });
        ...
        describe('#charset', function() {
            describe('#encode', function() {
                it('should encode UTF-8 to ArrayBuffer', function() {
                    ...
                    expect(encoded).to.deep.equal(mimecodec.charset.encode(str));
                });
            });
            ...
            describe('#decode', function() {
                it('should decode utf-8 arraybuffer', function() {
                    ...
                    expect(str).to.deep.equal(mimecodec.charset.decode(encoded));
                });
                ...
                it('should decode non utf-8 arraybuffer', function() {
                    ...
                    expect(str).to.deep.equal(mimecodec.charset.decode(encoded, encoding));
                });
            ...
            describe('#convert', function() {
                it('should convert non utf-8 to arraybuffer', function() {
                    ...
                    expect(converted).to.deep.equal(mimecodec.charset.convert(encoded, encoding));
                });
            });
        });
    });
